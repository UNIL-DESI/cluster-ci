...
|---|------|-------|-------------|--------|
| 1 | Investigation & Draft | Explorer analyse la base de code, les commandes, et rédige les maquettes/contenus de la doc. | None | IN_PROGRESS |
| 2 | Configuration & CI Setup | Worker configure `mkdocs.yml` et le workflow `.github/workflows/deploy-docs.yml`. | M1 | PLANNED |
