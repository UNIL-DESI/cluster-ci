...
!!! note "Internal Details"
    For technical details on the garbage collection algorithm (5-level progressive purge, emergency GC, lazy workspace transfer) and the historical DVC visualizer, see the [Infrastructure Internals](../admin/infrastructure_internals.md) documentation.
